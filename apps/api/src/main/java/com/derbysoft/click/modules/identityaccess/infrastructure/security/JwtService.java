...
public class JwtService {
  ...
  public String createAccessToken(ActorContext claims, long expiresInSeconds) {
  ...
  public ActorContext verifyAndExtract(String token) throws JWTVerificationException {
    DecodedJWT decoded = verifier.verify(token);
    return extractClaims(decoded);
  }

  private ActorContext extractClaims(DecodedJWT decoded) {
    ...
    return new ActorContext(userId, tenantId, email, role);
  }
}
